...
function getMaxAverage(arr,k){
    ...
    for(r = k-1;r < arr.length;r++){
        ...
        console.log("      Current window: " + subarr);
        //

        //Calculate the average and compare
        let currentAverage = averageOfSubarray(subarr);
        console.log("      Average of the window: " + currentAverage);
...
function averageOfSubarray(subarr){
        let sum = 0;
